        ...
        if (productRecipes.guranteed) {
            if (id === 0) {
                requiredIngredients = __spreadArrays(requiredIngredients, productRecipes.guranteed.map(function (x) {
                    return tableReader_1.extractIngredients({ specifiedItem: x.triggerIngredient })[0];
                }));
            }
            else if (id === 1) {
                ...
                if (firstIngredient_3 &&
                    ...
                    requiredIngredients = __spreadArrays(tableReader_1.extractIngredients({ specifiedItem: firstIngredient_3 }));
                }
            }
            else if (id === 3) {
                ...
                if (firstIngredient_4 &&
                    ...
                    requiredIngredients = __spreadArrays(tableReader_1.extractIngredients({ specifiedItem: firstIngredient_4 }));
                }
            }
        }
