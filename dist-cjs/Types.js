...
exports.isBallProduct = exports.isGuaranteedProduct = exports.isStandardProduct = exports.isProduct = exports.isIngredient = exports.ProductList = exports.BallProductList = exports.GuaranteedProductList = exports.StandardProductList = exports.IngredientList = exports.TypeList = void 0;
// prettier-ignore
exports.TypeList = ['ノーマル', 'かくとう', 'ひこう', 'どく', 'じめん', 'いわ', 'むし', 'ゴースト', 'はがね', 'ほのお', 'みず', 'くさ', 'でんき', 'エスパー', 'こおり', 'ドラゴン', 'あく', 'フェアリー'];
// prettier-ignore
exports.IngredientList = [
    ...
    'ドラゴンメモリ', 'しんかのきせき', 'ダイこうせき', 'いのちのたま', 'りゅうのキバ', 'りゅうのウロコ', 'カセキのリュウ', 'ダイマックスアメ', 'ジャポのみ', 'バンジのみ', 'ハバンのみ',
    ...
    'アイスメモリ', 'すいせいのかけら', 'とけないこおり', 'リュガのみ', 'つめたいいわ', 'カセキのクビナガ', 'ゆきだま', 'こおりのいし', 'ザクロのみ', 'ヤチェのみ', 'ナナシのみ',
    'とくせいカプセル', 'ポイントマックス', 'ポイントアップ', 'とくせいパッチ', 'おまもりこばん', 'アップグレード', 'スピードパウダー', 'せんせいのツメ', 'シルクのスカーフ', 'こだわりスカーフ', 'しあわせタマゴ', 'ぼうじんゴーグル', 'ノーマルジュエル', 'ホズのみ', 'まんぷくおこう', 'こううんのおこう', 'しろぼんぐり',
    'ポイズンメモリ', 'どくバリ', 'ねがいのかたまり', 'けむりだま', 'ガラナツブレス', 'どくどくだま', 'ヤタピのみ', 'くろいヘドロ', 'タポルのみ', 'ビアーのみ', 'ゴールドスプレー', 'オレンのみ', 'むしよけスプレー', 'シルバースプレー', 'ふしぎなアメ',
    'サイキックメモリ', 'あかいいと', 'ルームサービス', 'こだわりメガネ', 'ひかりのねんど', 'パワーレンズ', 'ガラナツリース', 'まがったスプーン', 'けいけんアメXL', 'スターのみ', 'ものしりメガネ', 'けいけんアメL', 'サイコシード', 'めざめのいし', 'けいけんアメM', 'マトマのみ', 'けいけんアメS', 'ウタンのみ', 'けいけんアメXS', 'のんきのおこう', 'きよめのおこう', 'オボンのみ',
...
// prettier-ignore
exports.GuaranteedProductList = [
    'おおきなキノコ', 'おおきなしんじゅ', 'ほしのかけら', 'かおるキノコ', 'でかいきんのたま', 'おだんごしんじゅ', 'すいせいのかけら', 'とくせいカプセル', 'きんのおうかん', 'ポイントアップ'
];
// prettier-ignore
exports.BallProductList = [
...
exports.ProductList = __spreadArrays(exports.StandardProductList, exports.GuaranteedProductList, exports.BallProductList).filter(function (v, i, self) {
    return i === self.indexOf(v);
});
function isIngredient(arg) {
    if (typeof arg === 'string') {
        if (exports.IngredientList.includes(arg)) {
            return true;
        }
    }
    return false;
}
exports.isIngredient = isIngredient;
function isProduct(arg) {
    if (typeof arg === 'string') {
...
function isStandardProduct(arg) {
    if (typeof arg === 'string') {
        if (exports.StandardProductList.includes(arg)) {
            return true;
        }
    }
    return false;
}
exports.isStandardProduct = isStandardProduct;
function isGuaranteedProduct(arg) {
    if (typeof arg === 'string') {
        if (exports.GuaranteedProductList.includes(arg)) {
            return true;
        }
    }
    return false;
}
exports.isGuaranteedProduct = isGuaranteedProduct;
function isBallProduct(arg) {
    if (typeof arg === 'string') {
        if (exports.BallProductList.includes(arg)) {
            return true;
        }
    }
    return false;
}
exports.isBallProduct = isBallProduct;
